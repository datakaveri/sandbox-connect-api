...
Sandbox Connect lets users reserve CPU or GPU notebook sessions and open them as managed Jupyter sandboxes. In this branch, users do not create notebooks directly. They create a booking, and the booking lifecycle provisions, starts, expires, and cleans up the notebook resources.
...
4. Check slot availability for the category and date you want.
