...
type CronEnv struct {
	...
	// Enable only after migrations/001_outputs.sql has been applied.
	// When enabled, cleanup never removes a PVC held by an active output.
	OutputsEnabled bool `env:"SLOT_LIFECYCLE_OUTPUTS_ENABLED" envDefault:"false"`
